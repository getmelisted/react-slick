          ...
          return (
            ...
            (t.prototype.render = function() {
              ...
              s &&
                ...
                (s = !1),
                (e.variableWidth = !1));
              for (var l = [], d = null, p = 0; p < r.length; p += i * o) {
                for (var f = [], v = p; v < p + i * o; v += o) {
                  for (
                    var y = [], g = v;
                    g < v + o &&
                    (s && r[g].props.style && (d = r[g].props.style.width),
                    !(g >= r.length));
                    g += 1
                  )
                    y.push(
                      c.default.cloneElement(r[g], {
                        key: 100 * p + 10 * v + g,
                        tabIndex: -1,
                        style: { width: 100 / o + "%", display: "inline-block" }
                      })
                    );
                  f.push(
                    c.default.createElement("div", { key: 10 * p + v }, y)
                  );
                }
                s
                  ? l.push(
                  ...
                  : l.push(c.default.createElement("div", { key: p }, f));
              }
              if ("unslick" === e) {
                var S = "regular slider " + (this.props.className || "");
                return c.default.createElement("div", { className: S }, l);
              }
              return (
        ...
        function t(n) {
          ...
          return (
            ...
            (r.updateState = function(e, t, n) {
              var i = (0, w.initializedState)(e);
              e = c({}, e, i, { slideIndex: i.currentSlide });
              var o = (0, w.getTrackLeft)(e);
              e = c({}, e, { left: o });
              var s = (0, w.getTrackCSS)(e);
              (t ||
            ...
            (r.ssrInit = function() {
              ...
              var f = d.default.Children.count(r.props.children),
                ...
                v = (0, w.getPreClones)(h) + (0, w.getPostClones)(h) + f,
                y = (100 / r.props.slidesToShow) * v,
                g = 100 / v,
                S =
                  (-g * ((0, w.getPreClones)(h) + r.state.currentSlide) * y) /
                  100;
              r.props.centerMode && (S += (100 - (g * y) / 100) / 2);
              var m = { width: y + "%", left: S + "%" };
              r.setState({ slideWidth: g + "%", trackStyle: m });
            }),
            ...
            (r.render = function() {
              var e = (0, m.default)("slick-slider", r.props.className, {
    ...
    function(e, t) {
      (function(t) {
        function n(e, t, n) {
          ...
          function o(e) {
            return (O = e), (m = setTimeout(u, t)), _ ? i(e) : S;
          }
          function l(e) {
            var n = e - T,
              r = e - O,
          ...
          function u() {
            var e = k();
            return c(e) ? d(e) : void (m = setTimeout(u, l(e)));
          }
          function d(e) {
            return (m = void 0), E && v ? i(e) : ((v = y = void 0), S);
          }
          function p() {
            void 0 !== m && clearTimeout(m), (O = 0), (v = T = y = m = void 0);
          }
          function f() {
            return void 0 === m ? S : d(k());
          }
          function h() {
            var e = k(),
              n = c(e);
            if (((v = arguments), (y = this), (T = e), n)) {
              if (void 0 === m) return o(T);
              if (x) return (m = setTimeout(u, t)), i(T);
            }
            return void 0 === m && (m = setTimeout(u, t)), S;
          }
          var v,
            y,
            g,
	...
	*/
    ...
    function(e, t, n) {
      ...
      var i =
        ...
        (t.slideHandler = function(e) {
          ...
          if (r) {
            ...
            (S = y),
              ...
              (m = O(i({}, e, { slideIndex: y }))),
              (w = O(i({}, e, { slideIndex: S }))),
              o || (m === w && (y = S), (m = w)),
              ...
              v
                ? ((b = {
                    animating: !0,
                    currentSlide: S,
                    trackStyle: T(i({}, e, { left: m })),
                    lazyLoadedList: l
                  }),
                  (_ = {
                    animating: !1,
                    currentSlide: S,
                    trackStyle: k(i({}, e, { left: w })),
                    swipeLeft: null
                  }))
                : (b = {
                    currentSlide: S,
            ...
            return (
              m ||
                (((0 === c && "right" === H) ||
                  ...
                  (!g(t) && "left" === H)) &&
                  ((P = w.swipeLength * u),
                  d === !1 && p && (p(H), (E.edgeDragged = !0)))),
              !f && b && (b(H), (E.swiped = !0)),
              (x = o ? M + P * (T / _) * C : l ? M - P * C : M + P * C),
              a && (x = M + P * C),
              (E = i({}, E, {
                touchObject: w,
                swipeLeft: x,
        ...
        (t.swipeEnd = function(e, t) {
          ...
          if (o.swipeLength > h) {
            ...
            switch (v) {
              case "left":
              case "up":
                (b = u + w(t)), (S = d ? m(t, b) : b), (g.currentDirection = 0);
                break;
              case "right":
              case "down":
                (b = u - w(t)), (S = d ? m(t, b) : b), (g.currentDirection = 1);
                break;
              default:
                S = u;
            }
        ...
        m = (t.checkNavigable = function(e, t) {
          var n = S(e),
            r = 0;
        ...
        O = (t.getTrackLeft = function(e) {
          ...
          if (
            ...
            if (
              ...
              (w = o ? r + _(e) : r), (n = k && k.children[w]), (t = 0);
              for (var T = 0; T < w; T++)
        ...
        !(function(t, n) {
          ...
          (m.prototype.addObserver = function(e) {
            ...
            (m.getInstance = function() {
              return (
                this.instance_ || (this.instance_ = new m()), this.instance_
              );
            }),
            (m.instance_ = null);
          var w = function(e, t) {
